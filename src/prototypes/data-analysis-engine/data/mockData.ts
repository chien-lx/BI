...
export const dataScreens: DataScreenItem[] = [
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc1-c1', name: 'GMV 实时趋势', type: 'line', x: 40, y: 80, w: 800, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc1-c2', name: '品类销售占比', type: 'pie', x: 880, y: 80, w: 520, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc1-c3', name: '今日成交额', type: 'card', x: 1440, y: 80, w: 320, h: 160 , datasetName: '订单明细数据集' },
      { id: 'sc1-c4', name: '订单量趋势', type: 'area', x: 40, y: 480, w: 920, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc1-c5', name: 'TOP 城市排行', type: 'bar', x: 1000, y: 480, w: 760, h: 360 , datasetName: '订单明细数据集' },
    ],
  },
  {
    ...
    bgColor: '#050b1a',
    components: [
      { id: 'sc2-c1', name: '全网销售额', type: 'card', x: 80, y: 100, w: 400, h: 180 , datasetName: '订单明细数据集' },
      { id: 'sc2-c2', name: '用户增长曲线', type: 'line', x: 520, y: 100, w: 900, h: 420 , datasetName: '用户画像数据集' },
      { id: 'sc2-c3', name: '渠道占比', type: 'pie', x: 1460, y: 100, w: 520, h: 420 , datasetName: '营销活动数据集' },
      { id: 'sc2-c4', name: '订单热力图', type: 'bar', x: 80, y: 560, w: 1200, h: 520 , datasetName: '订单明细数据集' },
      { id: 'sc2-c5', name: '实时库存', type: 'area', x: 1320, y: 560, w: 900, h: 520 , datasetName: '商品信息数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc3-c1', name: '在途订单数', type: 'card', x: 60, y: 80, w: 340, h: 160 , datasetName: '物流轨迹数据集' },
      { id: 'sc3-c2', name: '物流时效趋势', type: 'line', x: 440, y: 80, w: 780, h: 360 , datasetName: '物流轨迹数据集' },
      { id: 'sc3-c3', name: '仓储分布', type: 'pie', x: 1260, y: 80, w: 500, h: 360 , datasetName: '库存实时数据集' },
      { id: 'sc3-c4', name: '缺货预警', type: 'bar', x: 60, y: 480, w: 900, h: 360 , datasetName: '商品信息数据集' },
      { id: 'sc3-c5', name: '到货准时率', type: 'area', x: 1000, y: 480, w: 760, h: 360 , datasetName: '物流轨迹数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc4-c1', name: '营业收入', type: 'card', x: 40, y: 60, w: 280, h: 140 , datasetName: '财务报表数据集' },
      { id: 'sc4-c2', name: '净利润', type: 'card', x: 340, y: 60, w: 280, h: 140 , datasetName: '财务报表数据集' },
      { id: 'sc4-c3', name: '收支趋势', type: 'line', x: 40, y: 240, w: 920, h: 360 , datasetName: '财务报表数据集' },
      { id: 'sc4-c4', name: '成本结构', type: 'pie', x: 1000, y: 240, w: 520, h: 360 , datasetName: '财务报表数据集' },
      { id: 'sc4-c5', name: '费用对比', type: 'bar', x: 40, y: 640, w: 1480, h: 320 , datasetName: '财务报表数据集' },
    ],
  },
  {
    ...
    bgColor: '#050b1a',
    components: [
      { id: 'sc5-c1', name: '拥堵指数', type: 'card', x: 60, y: 80, w: 360, h: 160 , datasetName: '地理围栏数据集' },
      { id: 'sc5-c2', name: '流量趋势', type: 'line', x: 460, y: 80, w: 820, h: 360 , datasetName: '地理围栏数据集' },
      { id: 'sc5-c3', name: '事故类型分布', type: 'pie', x: 1320, y: 80, w: 480, h: 360 , datasetName: '地理围栏数据集' },
      { id: 'sc5-c4', name: '主干道车速', type: 'bar', x: 60, y: 480, w: 900, h: 360 , datasetName: '地理围栏数据集' },
      { id: 'sc5-c5', name: '通行量预测', type: 'area', x: 1000, y: 480, w: 800, h: 360 , datasetName: '地理围栏数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc6-c1', name: '产量达成率', type: 'card', x: 40, y: 60, w: 320, h: 160 , datasetName: '商品信息数据集' },
      { id: 'sc6-c2', name: '设备 OEE', type: 'card', x: 380, y: 60, w: 320, h: 160 , datasetName: '库存实时数据集' },
      { id: 'sc6-c3', name: '产线良率', type: 'line', x: 40, y: 260, w: 760, h: 340 , datasetName: '商品信息数据集' },
      { id: 'sc6-c4', name: '缺陷分布', type: 'pie', x: 840, y: 260, w: 520, h: 340 , datasetName: '商品信息数据集' },
      { id: 'sc6-c5', name: '能耗趋势', type: 'area', x: 40, y: 640, w: 1320, h: 320 , datasetName: '库存实时数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc7-c1', name: '今日销售额', type: 'card', x: 40, y: 60, w: 300, h: 140 , datasetName: '订单明细数据集' },
      { id: 'sc7-c2', name: '客流趋势', type: 'line', x: 40, y: 240, w: 920, h: 340 , datasetName: '订单明细数据集' },
      { id: 'sc7-c3', name: '品类占比', type: 'pie', x: 1000, y: 240, w: 520, h: 340 , datasetName: '商品信息数据集' },
      { id: 'sc7-c4', name: '时段销售', type: 'bar', x: 40, y: 620, w: 1480, h: 340 , datasetName: '订单明细数据集' },
    ],
  },
  {
    ...
    bgColor: '#050b1a',
    components: [
      { id: 'sc8-c1', name: '总能耗', type: 'card', x: 60, y: 80, w: 360, h: 160 , datasetName: '库存实时数据集' },
      { id: 'sc8-c2', name: '能耗趋势', type: 'line', x: 460, y: 80, w: 880, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc8-c3', name: '能源结构', type: 'pie', x: 1380, y: 80, w: 480, h: 360 , datasetName: '库存实时数据集' },
      { id: 'sc8-c4', name: '区域能耗对比', type: 'bar', x: 60, y: 480, w: 920, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc8-c5', name: '碳排放预测', type: 'area', x: 1020, y: 480, w: 840, h: 360 , datasetName: '库存实时数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc9-c1', name: '在院患者', type: 'card', x: 40, y: 60, w: 320, h: 160 , datasetName: '用户画像数据集' },
      { id: 'sc9-c2', name: '床位使用率', type: 'card', x: 380, y: 60, w: 320, h: 160 , datasetName: '用户画像数据集' },
      { id: 'sc9-c3', name: '科室负荷', type: 'bar', x: 40, y: 260, w: 760, h: 340 , datasetName: '用户画像数据集' },
      { id: 'sc9-c4', name: '急救趋势', type: 'line', x: 840, y: 260, w: 520, h: 340 , datasetName: '用户画像数据集' },
      { id: 'sc9-c5', name: '药品库存', type: 'area', x: 40, y: 640, w: 1320, h: 320 , datasetName: '库存实时数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc10-c1', name: '学生总数', type: 'card', x: 40, y: 60, w: 300, h: 140 , datasetName: '用户画像数据集' },
      { id: 'sc10-c2', name: '成绩分布', type: 'bar', x: 40, y: 240, w: 920, h: 340 , datasetName: '用户画像数据集' },
      { id: 'sc10-c3', name: '学科占比', type: 'pie', x: 1000, y: 240, w: 520, h: 340 , datasetName: '用户画像数据集' },
      { id: 'sc10-c4', name: '出勤趋势', type: 'line', x: 40, y: 620, w: 1480, h: 340 , datasetName: '用户画像数据集' },
    ],
  },
  {
    ...
    bgColor: '#050b1a',
    components: [
      { id: 'sc11-c1', name: '风险交易数', type: 'card', x: 80, y: 100, w: 400, h: 180 , datasetName: '风控规则数据集' },
      { id: 'sc11-c2', name: '交易趋势', type: 'line', x: 520, y: 100, w: 900, h: 420 , datasetName: '风控规则数据集' },
      { id: 'sc11-c3', name: '风险类型', type: 'pie', x: 1460, y: 100, w: 520, h: 420 , datasetName: '风控规则数据集' },
      { id: 'sc11-c4', name: '拦截统计', type: 'bar', x: 80, y: 560, w: 1200, h: 520 , datasetName: '风控规则数据集' },
      { id: 'sc11-c5', name: '规则命中', type: 'area', x: 1320, y: 560, w: 900, h: 520 , datasetName: '支付流水数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc12-c1', name: '园区总人数', type: 'card', x: 60, y: 80, w: 360, h: 160 , datasetName: '用户画像数据集' },
      { id: 'sc12-c2', name: '能耗监控', type: 'line', x: 460, y: 80, w: 860, h: 360 , datasetName: '库存实时数据集' },
      { id: 'sc12-c3', name: '车位占用', type: 'pie', x: 1360, y: 80, w: 480, h: 360 , datasetName: '用户画像数据集' },
      { id: 'sc12-c4', name: '安防事件', type: 'bar', x: 60, y: 480, w: 920, h: 360 , datasetName: '用户画像数据集' },
      { id: 'sc12-c5', name: '环境监测', type: 'area', x: 1020, y: 480, w: 820, h: 360 , datasetName: '库存实时数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc13-c1', name: '办件总量', type: 'card', x: 40, y: 60, w: 300, h: 140 , datasetName: '审计日志数据集' },
      { id: 'sc13-c2', name: '事项办理趋势', type: 'line', x: 40, y: 240, w: 920, h: 340 , datasetName: '审计日志数据集' },
      { id: 'sc13-c3', name: '部门占比', type: 'pie', x: 1000, y: 240, w: 520, h: 340 , datasetName: '审计日志数据集' },
      { id: 'sc13-c4', name: '满意度评价', type: 'bar', x: 40, y: 620, w: 1480, h: 340 , datasetName: '审计日志数据集' },
    ],
  },
  {
    ...
    bgColor: '#050b1a',
    components: [
      { id: 'sc14-c1', name: '实时观众', type: 'card', x: 60, y: 80, w: 360, h: 160 , datasetName: '用户画像数据集' },
      { id: 'sc14-c2', name: '收视趋势', type: 'line', x: 460, y: 80, w: 860, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc14-c3', name: '平台分布', type: 'pie', x: 1360, y: 80, w: 480, h: 360 , datasetName: '用户画像数据集' },
      { id: 'sc14-c4', name: '热门项目', type: 'bar', x: 60, y: 480, w: 920, h: 360 , datasetName: '订单明细数据集' },
      { id: 'sc14-c5', name: '互动量', type: 'area', x: 1020, y: 480, w: 820, h: 360 , datasetName: '订单明细数据集' },
    ],
  },
  {
    ...
    bgColor: '#0b1121',
    components: [
      { id: 'sc15-c1', name: '今日客流', type: 'card', x: 40, y: 60, w: 320, h: 160 , datasetName: '用户画像数据集' },
      { id: 'sc15-c2', name: '客流预测', type: 'line', x: 40, y: 260, w: 760, h: 340 , datasetName: '用户画像数据集' },
      { id: 'sc15-c3', name: '来源地分布', type: 'pie', x: 840, y: 260, w: 520, h: 340 , datasetName: '地理围栏数据集' },
      { id: 'sc15-c4', name: '景区热度', type: 'bar', x: 40, y: 640, w: 1320, h: 320 , datasetName: '地理围栏数据集' },
    ],
  },
];
...
export const datasetFields: Record<string, DatasetField[]> = {
  ...
  '商品信息数据集': [
    { name: '上架日期', type: 'dimension', dataType: '日期' },
    { name: '商品品类', type: 'dimension', dataType: '文本' },
    { name: '商品名称', type: 'dimension', dataType: '文本' },
    { name: '品牌', type: 'dimension', dataType: '文本' },
    { name: '售价', type: 'metric', dataType: '数值' },
    { name: '库存数量', type: 'metric', dataType: '数值' },
    { name: '销量', type: 'metric', dataType: '数值' },
  ],
  '物流轨迹数据集': [
    { name: '运单号', type: 'dimension', dataType: '文本' },
    { name: '省份', type: 'dimension', dataType: '文本' },
    { name: '城市', type: 'dimension', dataType: '文本' },
    { name: '运输状态', type: 'dimension', dataType: '文本' },
    { name: '发货时间', type: 'dimension', dataType: '日期' },
    { name: '配送时效(小时)', type: 'metric', dataType: '数值' },
    { name: '订单数量', type: 'metric', dataType: '数值' },
  ],
  '财务报表数据集': [
    { name: '会计期间', type: 'dimension', dataType: '文本' },
    { name: '会计科目', type: 'dimension', dataType: '文本' },
    { name: '借方金额', type: 'metric', dataType: '数值' },
    { name: '贷方金额', type: 'metric', dataType: '数值' },
    { name: '利润', type: 'metric', dataType: '数值' },
  ],
  '访问日志数据集': [
    { name: '访问日期', type: 'dimension', dataType: '日期' },
    { name: '页面', type: 'dimension', dataType: '文本' },
    { name: '事件类型', type: 'dimension', dataType: '文本' },
    { name: '访问IP', type: 'dimension', dataType: '文本' },
    { name: '访问量(PV)', type: 'metric', dataType: '数值' },
    { name: '独立访客(UV)', type: 'metric', dataType: '数值' },
    { name: '停留时长(秒)', type: 'metric', dataType: '数值' },
  ],
  '营销活动数据集': [
    { name: '活动名称', type: 'dimension', dataType: '文本' },
    { name: '渠道', type: 'dimension', dataType: '文本' },
    { name: '开始日期', type: 'dimension', dataType: '日期' },
    { name: '投入成本', type: 'metric', dataType: '数值' },
    { name: '带来GMV', type: 'metric', dataType: '数值' },
    { name: 'ROI', type: 'metric', dataType: '数值' },
    { name: '参与人数', type: 'metric', dataType: '数值' },
  ],
  '库存实时数据集': [
    { name: '仓库', type: 'dimension', dataType: '文本' },
    { name: '商品品类', type: 'dimension', dataType: '文本' },
    { name: '库存数量', type: 'metric', dataType: '数值' },
    { name: '在途数量', type: 'metric', dataType: '数值' },
    { name: '可用库存', type: 'metric', dataType: '数值' },
    { name: '周转天数', type: 'metric', dataType: '数值' },
  ],
  '埋点事件数据集': [
    { name: '事件日期', type: 'dimension', dataType: '日期' },
    { name: '事件类型', type: 'dimension', dataType: '文本' },
    { name: '页面', type: 'dimension', dataType: '文本' },
    { name: '用户ID', type: 'dimension', dataType: '文本' },
    { name: '事件次数', type: 'metric', dataType: '数值' },
    { name: '会话数', type: 'metric', dataType: '数值' },
  ],
  'CRM 客户数据集': [
    { name: '客户名称', type: 'dimension', dataType: '文本' },
    { name: '行业', type: 'dimension', dataType: '文本' },
    { name: '所在城市', type: 'dimension', dataType: '文本' },
    { name: '会员等级', type: 'dimension', dataType: '文本' },
    { name: '消费总额', type: 'metric', dataType: '数值' },
    { name: '订单次数', type: 'metric', dataType: '数值' },
    { name: '客户价值', type: 'metric', dataType: '数值' },
  ],
  '风控规则数据集': [
    { name: '规则ID', type: 'dimension', dataType: '文本' },
    { name: '风险等级', type: 'dimension', dataType: '文本' },
    { name: '交易日期', type: 'dimension', dataType: '日期' },
    { name: '交易金额', type: 'metric', dataType: '数值' },
    { name: '是否异常', type: 'dimension', dataType: '文本' },
    { name: '拦截次数', type: 'metric', dataType: '数值' },
  ],
  '供应链数据集': [
    { name: '供应商', type: 'dimension', dataType: '文本' },
    { name: '商品品类', type: 'dimension', dataType: '文本' },
    { name: '采购数量', type: 'metric', dataType: '数值' },
    { name: '缺货数量', type: 'metric', dataType: '数值' },
    { name: '采购金额', type: 'metric', dataType: '数值' },
    { name: '交付周期(天)', type: 'metric', dataType: '数值' },
  ],
  'BI 报表宽表': [
    { name: '统计日期', type: 'dimension', dataType: '日期' },
    { name: '业务线', type: 'dimension', dataType: '文本' },
    { name: '指标名称', type: 'dimension', dataType: '文本' },
    { name: '指标值', type: 'metric', dataType: '数值' },
    { name: '同比', type: 'metric', dataType: '数值' },
    { name: '环比', type: 'metric', dataType: '数值' },
  ],
  '用户行为明细': [
    { name: '行为日期', type: 'dimension', dataType: '日期' },
    { name: '行为类型', type: 'dimension', dataType: '文本' },
    { name: '页面', type: 'dimension', dataType: '文本' },
    { name: '城市', type: 'dimension', dataType: '文本' },
    { name: '用户ID', type: 'dimension', dataType: '文本' },
    { name: '停留时长(秒)', type: 'metric', dataType: '数值' },
    { name: '转化次数', type: 'metric', dataType: '数值' },
  ],
  '支付流水数据集': [
    { name: '支付日期', type: 'dimension', dataType: '日期' },
    { name: '支付方式', type: 'dimension', dataType: '文本' },
    { name: '交易流水号', type: 'dimension', dataType: '文本' },
    { name: '交易金额', type: 'metric', dataType: '数值' },
    { name: '手续费率', type: 'metric', dataType: '数值' },
    { name: '到账金额', type: 'metric', dataType: '数值' },
  ],
  '商品搜索数据集': [
    { name: '搜索日期', type: 'dimension', dataType: '日期' },
    { name: '搜索词', type: 'dimension', dataType: '文本' },
    { name: '城市', type: 'dimension', dataType: '文本' },
    { name: '搜索次数', type: 'metric', dataType: '数值' },
    { name: '点击次数', type: 'metric', dataType: '数值' },
    { name: '点击率', type: 'metric', dataType: '数值' },
  ],
  '消息队列日志集': [
    { name: '队列主题', type: 'dimension', dataType: '文本' },
    { name: '堆积时间', type: 'dimension', dataType: '日期' },
    { name: '积压量', type: 'metric', dataType: '数值' },
    { name: '吞吐量(TPS)', type: 'metric', dataType: '数值' },
    { name: '消费延迟(ms)', type: 'metric', dataType: '数值' },
  ],
  '审计日志数据集': [
    { name: '操作日期', type: 'dimension', dataType: '日期' },
    { name: '操作类型', type: 'dimension', dataType: '文本' },
    { name: '操作人', type: 'dimension', dataType: '文本' },
    { name: '操作对象', type: 'dimension', dataType: '文本' },
    { name: '操作次数', type: 'metric', dataType: '数值' },
  ],
  '文件元数据集': [
    { name: '上传日期', type: 'dimension', dataType: '日期' },
    { name: '文件类型', type: 'dimension', dataType: '文本' },
    { name: '文件名称', type: 'dimension', dataType: '文本' },
    { name: '文件大小(MB)', type: 'metric', dataType: '数值' },
    { name: '访问次数', type: 'metric', dataType: '数值' },
    { name: '下载次数', type: 'metric', dataType: '数值' },
  ],
  '配置变更数据集': [
    { name: '变更日期', type: 'dimension', dataType: '日期' },
    { name: '变更类型', type: 'dimension', dataType: '文本' },
    { name: '配置项', type: 'dimension', dataType: '文本' },
    { name: '变更人', type: 'dimension', dataType: '文本' },
    { name: '变更次数', type: 'metric', dataType: '数值' },
  ],
  '地理围栏数据集': [
    { name: '围栏名称', type: 'dimension', dataType: '文本' },
    { name: '地区', type: 'dimension', dataType: '文本' },
    { name: '进入次数', type: 'metric', dataType: '数值' },
    { name: '驻留时长(分钟)', type: 'metric', dataType: '数值' },
    { name: '经纬度', type: 'dimension', dataType: '文本' },
  ],
};
